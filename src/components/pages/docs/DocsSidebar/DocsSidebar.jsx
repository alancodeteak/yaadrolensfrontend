    ...
    <aside className={clsx(DOCS_PANEL, 'shrink-0 p-3 lg:sticky lg:top-6 lg:w-56')}>
      ...
      <nav
        aria-label="Guide sections"
            className="flex gap-1 overflow-x-auto overscroll-x-contain pb-1 [-ms-overflow-style:none] [scrollbar-width:none] lg:flex-col lg:overflow-visible lg:pb-0 [&::-webkit-scrollbar]:hidden"
      >
