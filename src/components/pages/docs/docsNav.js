...
export const DOCS_NAV_ITEMS = [
  ...
  { name: 'Salary', href: '/docs/salary', icon: Banknote, tone: 'salary' },
  { name: 'Payment', href: '/docs/payroll', icon: CreditCard, tone: 'payroll' },
  { name: 'Reports', href: '/docs/reports', icon: FileText, tone: 'reports' },
