  ...
  return (
    <div ref={rootRef} className={clsx('relative', className)}>
      ...
      <button
        ...
        className="inline-flex min-w-[200px] items-center justify-between gap-2 rounded-xl border border-gray-200/60 bg-white px-3 py-2 text-sm text-gray-900 shadow-[0_2px_16px_rgba(0,0,0,0.04)] transition-colors hover:bg-gray-50/80 focus:border-[#007AFF] focus:outline-none focus:ring-2 focus:ring-[#007AFF]/20"
      >
      ...
      {open && (
        <div
          ...
          className="absolute left-0 z-50 mt-2 w-[280px] overflow-hidden rounded-2xl border border-gray-200/60 bg-white shadow-[0_8px_32px_rgba(0,0,0,0.12)]"
        >
